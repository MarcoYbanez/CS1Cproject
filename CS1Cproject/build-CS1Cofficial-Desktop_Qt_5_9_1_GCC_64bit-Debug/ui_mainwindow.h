...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral("assets/logo.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        move_btn->setPalette(palette7);
        QFont font5;
        font5.setBold(true);
        font5.setWeight(75);
        move_btn->setFont(font5);

        horizontalLayout_3->addWidget(move_btn);
        ...
        QBrush brush17(QColor(184, 207, 231, 255));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        move_btn->setText(QApplication::translate("MainWindow", "Move Shape", Q_NULLPTR));
